/*
 * Bare-metal driver adaptation for ES8388 Audio Codec
 * Compatible with STM32CubeMX HAL
 */

#ifndef __DRV_ES8388_H__
#define __DRV_ES8388_H__

#include "stm32f4xx_hal.h" // Gives access to HAL types like HAL_StatusTypeDef
